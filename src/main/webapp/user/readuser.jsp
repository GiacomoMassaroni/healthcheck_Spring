 ...
 <%UserDTO u = (UserDTO) request.getSession().getAttribute("dto");%>
    <div class="main container d-flex justify-content-center align-items-center vh-100" style="padding-top: 8em;">
        <div class="w-75 border border-primary my-2 p-5 rounded-4">
            <h1  class="my-2 text-center" style="color: #002B7E;">Info <%=u.getEmail()%></h1>

            <div class="d-flex w-100">
                <div class="w-100 border m-3 h-100">
        ...
        <%RegistryDTO r = (RegistryDTO) request.getSession().getAttribute("registryDto");%>
            ...
            <div class="d-flex justify-content-center">
                <ul class="list-group my-3  w-75">
                   <li class="list-group-item"><span style="color: #002B7E;">Nome: </span><%=r.getName()%></li>
                   <li class="list-group-item"><span style="color: #002B7E;">Cognome: </span><%=r.getSurname()%></li>
                   ...
                   <li class="list-group-item"><span style="color: #002B7E;">Nazione: </span><%=r.getNationality()%></li>
                   <li class="list-group-item"><span style="color: #002B7E;">Citt&#224: </span><%=r.getCity()%></li>
                   <li class="list-group-item"><span style="color: #002B7E;">Indirizzo: </span><%=r.getAddress()%></li>
                   <li class="list-group-item"><span style="color: #002B7E;">Cf: </span><%=r.getCf()%></li>
