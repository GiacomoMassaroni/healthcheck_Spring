    ...
    %>
        ...
        <div class="d-flex justify-content-center">
	        <ul class="list-group my-3  w-50">
	          ...
	          <li class="list-group-item"><span style="color: #002B7E;">Dottore:</span> <%=bloodTest.getIdAdmin()%></li>
	          <li class="list-group-item"><span style="color: #002B7E;">Paziente:</span> <%=bloodTest.getIdUser()%></li>
